                    ...
                    <v-layout row justify-center>
                        ...
                        <v-card>
                            ...
                            <template>
                                ...
                                <v-card-actions>
                                    <v-spacer></v-spacer>
                                    <v-btn color="blue darken-1" flat @click="deleteRole">Удалить роль</v-btn>
                                </v-card-actions>
                            </template>


                            <v-card-title>
                                <span class="headline">Страница роли</span>
                            </v-card-title>
...
<script>
    export default {
        ...
        methods: {
            ...
            update: function () {
                var path = this.$root.path + "roles/" + this.id;
                console.log("Обновляем информацию о роли" + path);
            ...
            create: function () {
                var path = this.$root.path + "roles/";
                console.log("Создаем новую роль" + path);
            ...
            deleteRole: function () {
                ...
                alert("Сейчас будет произведено удаление роли");
                var ResponseData = null;
                this.$root.$http
                    .delete(path)
                    .then(response => {
